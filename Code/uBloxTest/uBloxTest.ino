...
void setup()
{
	...
	byte settingsArray[] = {
	0x06,														// [0]NavMode
	0xE8, 0x03,											// [1]DataRate1, [2]DataRate2
	0x00, 0xC2, 0x01,								// [3]PortRateByte1, [4]PortRateByte2, [5]PortRateByte3
	0x00, 0x00, 0x00, 0x00, 0x00};	// [6]NMEA GLL Sentence, [7]NMEA GSA Sentence, [8]NMEA GSV Sentence, [9]NMEA RMC Sentence, [10]NMEA VTG Sentence
